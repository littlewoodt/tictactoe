...
//    there has got to be a simpler way to do this
    ...
    isWinner: function ( ) 
      ...
      if ( 
          ...
          ( $( '.diag1' ).text() || $( '.diag1' ).text() || $( '.diag1' ).text() ) ||
          ( $( '.diag2' ).text() || $( '.diag2' ).text() || $( '.diag2' ).text() ) === 
          ( player1+player1+player1 || player2+player2+player2 ) {

            winner = player1;


      $( '.row1' ).text() || $( '.row2' ).text() || $( '.row3' ).text() === player1+player1+player1 || player2+player2+player2; // wins rows
...
// debugger;
    ...
    TicTacToe.player( TicTacToe.pieces[0] , TicTacToe.pieces[1] );
